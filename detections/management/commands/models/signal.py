...
class Signal:
    ...
    def is_move(self, coords: (float, float), move_tolerance_margin_norm):
        return abs(self.norm_x_center - coords[0]) > move_tolerance_margin_norm \
            or abs(self.norm_y_center - coords[1]) > move_tolerance_margin_norm
