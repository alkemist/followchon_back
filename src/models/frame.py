...
class Frame:
    ...
    def set_capture_min_conf(capture_min_conf):
        Frame.capture_min_conf = capture_min_conf
    ...
    def save(self):
        capture = Capture()
        capture.write(self.frame, Frame.capture_width, Frame.capture_height, self.annotations)
